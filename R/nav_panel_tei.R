...
#'
#' @examples
nav_panel_tei <- function() {
  return(
    nav_panel("RDB",icon = bs_icon("search"),
              navset_card_underline(
                nav_panel("Vue d'ensemble",
                          ...
                          card(card_header("Analyse sur longue période"),
                               card_body(highchartOutput("tei_hc_synth"),
                                         sliderInput(inputId = "date_tei",
                                                     label = "Années",
                                                     min = 1949,
                                                     max = 2023,
                                                     value = c(2000,2023),
                          ...
                          card(card_header("Données brutes"),
                               card_body(DTOutput("donnees_tei")))),
